...
const RiskAlert = ({ onBack, onOpenExpert }) => (
  <Chrome hideTabs>
    <TopNav back onBack={onBack} title="Private guidance" lang={false}
      right={<span className="chip danger"><Icon.lock size={10}/> Only you can see this</span>}/>
    <div className="risk-screen">
      ...
      <p className="lead">
        ...
        This notice is visible <strong>only to you</strong>; other users cannot see it.
      </p>
